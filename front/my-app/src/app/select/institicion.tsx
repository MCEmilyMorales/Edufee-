  ...
  return (
    <div className="p-0 relative flex flex-row top-0 //bg-blue-800 h-[max] max-w-[1400px]  max-h-[300px] min-w-[70%] justify-between items-center">
      <section className="p-0 relative flex flex-row top-0 //bg-green-200 h-[100%] max-w-[65%]">
        <CardGeneral
          text="¡Simplifica tu administración y enfocáte en lo importante! Gestiona los pagos de tu institución de forma fácil y rápida con Edufee. Todo lo que necesitas en un solo lugar."
          bgColor="#F9B253"
          borderColor="#F98F53"
          shadowColor="#F1E5BE"
